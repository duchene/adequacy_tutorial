...
Begin by opening R. A quick way to run model assessment using the data in this tutorial is to source the file \lstinline!run.assessment.Rscript!, found in the main tutorial folder. You will need to make sure that the R working directory is the main tutorial folder. If you want to go through your own assessment of model adequacy, ignore sourcing this file and instead continue with the remainder of this section.

\begin{lstlisting}[language=R]
    source("run.assessment.Rscript")
\end{lstlisting}

Follow the next steps to perform your own assessment of model adequacy. By typing the following, you will set the working directory to the scripts folder, and then source all the functions inside it.
