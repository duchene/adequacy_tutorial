...
In this section we will run substitution and clock model assessment. We will be using the output from the BEAST 2 analysis that we ran in the previous section. However, \textbf{if you wish to perform model assessment for your own data, you should follow the steps in this section.} 
...
In addition, \lstinline!Nsim = 100! specifies the number of posterior predictive simulations to be performed.
...
us to take these data and run the posterior predictive simulations, which is shown in the green box in Figure \ref{fig:example1}. You
...
this example we will use the original tree provided (\lstinline!data/corvid.tre!), but usually the
